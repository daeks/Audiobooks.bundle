...
def SetupUrls(sitetype, base, lang='en'):
    ...
    ctx['AUD_SEARCH_URL'        ]=AUD_BASE_URL + 'search?' + AUD_TITLE_URL + '{0}&advsearchKeywords={1}&x=41&ipRedirectOverride=true'
    return ctx
